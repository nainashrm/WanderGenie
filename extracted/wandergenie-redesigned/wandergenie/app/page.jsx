...
import { mockGenerateItinerary } from '@/lib/api'
...
export default function HomePage() {
  ...
  const handleSubmit = async (formData) => {
    ...
    setError(null)
    try {
      const result = await mockGenerateItinerary(formData)
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative min-h-screen flex flex-col">
        {/* Background image via CSS — forest/mountain travel aesthetic */}
        <div
        ...
        >
          {/* Texture overlay — grid of subtle dots */}
          <div
